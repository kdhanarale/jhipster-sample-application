package com.vdlogic.emr.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.vdlogic.emr.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.vdlogic.emr.repository.UserRepository.USERS_BY_EMAIL_CACHE);
