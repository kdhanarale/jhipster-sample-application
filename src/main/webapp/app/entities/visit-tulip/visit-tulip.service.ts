...
export class VisitTulipService {
  ...
  protected convertDateFromClient(visit: IVisitTulip): IVisitTulip {
    const copy: IVisitTulip = Object.assign({}, visit, {
      scheduleDate: visit.scheduleDate && visit.scheduleDate.isValid() ? visit.scheduleDate.toJSON() : undefined,
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      res.body.scheduleDate = res.body.scheduleDate ? moment(res.body.scheduleDate) : undefined;
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((visit: IVisitTulip) => {
        visit.scheduleDate = visit.scheduleDate ? moment(visit.scheduleDate) : undefined;
